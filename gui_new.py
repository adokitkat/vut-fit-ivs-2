...
class Ui(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMaximumSize(QtCore.QSize(612, 653))
        font = QtGui.QFont()
        ...
        self.pushButton_13.setGeometry(QtCore.QRect(510, 230, 91, 191))
        font = QtGui.QFont()
        font.setPointSize(38)
        self.pushButton_13.setFont(font)
        self.pushButton_13.setObjectName("pushButton_13")
        self.pushButton_14 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_14.setGeometry(QtCore.QRect(510, 130, 91, 91))
        font = QtGui.QFont()
        font.setPointSize(38)
        self.pushButton_14.setFont(font)
        self.pushButton_14.setObjectName("pushButton_14")
        self.pushButton_15 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_15.setGeometry(QtCore.QRect(410, 130, 91, 91))
        font = QtGui.QFont()
        font.setPointSize(38)
        self.pushButton_15.setFont(font)
        self.pushButton_15.setObjectName("pushButton_15")
        self.pushButton_16 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_16.setGeometry(QtCore.QRect(310, 130, 91, 91))
        font = QtGui.QFont()
        font.setPointSize(38)
...
######################################################################
        ...
        self.pushButton_25.clicked.connect(self.root)#self.root)
        self.pushButton_26.clicked.connect(self.sqroot)
        
        self.pushButton_27.clicked.connect(lambda: self.numbers(pi))

        self.pushButton_23.clicked.connect(lambda: self.numbers("("))#braces("("))
        self.pushButton_24.clicked.connect(lambda: self.numbers(")"))#braces(")"))
...
######################################################################
    ...
    def init(self):
        ...
        self.lineEdit.setText(str(values[0]))
        overwrite_flag = 1
